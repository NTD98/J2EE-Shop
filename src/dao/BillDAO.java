...
public class BillDAO {
    ...
    public ArrayList<Bill> getListBillUserID(long user_id) {
        try {
            Connection connection = DBConnect.getConnecttion();
    ...
    public static void main(String[] args) throws SQLException {
        ...
        new BillDAO().insertBill(new Bill(0, 0, 0, "s", "s", "s", 0, new Timestamp(new Date().getTime())));
    }
}
