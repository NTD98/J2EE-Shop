<%-- 
    Document   : Single
    Created on : Jan 4, 2017, 10:26:42 AM
    Author     : Admin Kute
--%>
...
<html>
    <head>
        <title>Shop J2EE || Detail Product</title>
	      ...
	      <div class="single_grid">
				<div class="grid images_3_of_2">
						<ul id="etalage">
							...
							<li>
								<img class="etalage_thumb_image" src="<%=product.getProductImage()%>" class="img-responsive"  />
								<img class="etalage_source_image" src="<%=product.getProductImage()%>"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="<%=product.getProductImage()%>" class="img-responsive"  />
								<img class="etalage_source_image" src="<%=product.getProductImage()%>"class="img-responsive"  />
					...
					<p><%=product.getProductDescription()%></p>
			         ...
			         <div class="simpleCart_shelfItem">
			         	<div class="price_single">
						  <div class="head"><h2><span class="amount item_price"><%=product.getProductPrice()%> VND</span></h2></div>
						  
					       <div class="clearfix"></div>
					     </div>
			               <!--<div class="single_but"><a href="" class="item_add btn_3" value=""></a></div>-->
			              <div class="size_2-right"><a href="CartServlet?command=plus&productID=<%=product.getProductID()%>" class="item_add item_add1 btn_5" value="" />THÊM VÀO GIỎ HÀNG</a></div>
